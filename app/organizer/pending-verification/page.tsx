        ...
        <div className="min-h-screen bg-zinc-50 dark:bg-zinc-900 flex items-center justify-center p-4">
            <div className="bg-white dark:bg-zinc-800 rounded-lg shadow-lg p-8 max-w-md text-center">
                ...
                <p className="text-zinc-600 dark:text-zinc-400 mb-8">
                    Your organizer profile has been submitted for admin verification.
                    You'll be able to create events once your profile is approved.
                </p>

                <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 mb-8">
                    <p className="text-sm text-yellow-800 dark:text-yellow-200">
                        <strong>What's next?</strong><br />
                        Our admin team will review your details shortly. Once approved,
