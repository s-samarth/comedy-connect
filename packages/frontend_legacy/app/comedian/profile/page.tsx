import { getCurrentUser, requireComedian, isVerifiedComedian } from "@/lib/auth"
import { prisma } from "@/lib/prisma"
import ComedianProfileForm from "@/components/comedian/ComedianProfileForm"
        ...
        <div className="min-h-screen bg-zinc-50 p-8">
            <div className="max-w-4xl mx-auto">
                <div className="flex items-center justify-between mb-8">
                    <h1 className="text-3xl font-bold text-zinc-900">Comedian Profile</h1>
                    <a href="/comedian" className="text-pink-600 hover:underline">
                        ← Back to Dashboard
                    </a>
                </div>
