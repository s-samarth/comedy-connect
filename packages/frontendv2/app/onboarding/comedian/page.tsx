...
import { Loader2, Mic2, Instagram, Youtube, Twitter, Sparkles, Send, Video, Film, Plus, Trash2 } from 'lucide-react';
                            ...
                            <div className="space-y-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                ...
                                                <Input
                                                    ...
                                                    onChange={handleChange}
                                                    className="h-10 pl-7 rounded-full bg-muted/20 border-border"
                                                    placeholder="handle"
                                                />
                                            </div>
                                        </div>
                                ...
                                <div className="space-y-6 pt-4 border-t border-border/50">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-[10px] font-medium text-muted-foreground">Add links to your best performances to showcase on your profile.</p>
                                    </div>
