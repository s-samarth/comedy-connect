        ...
        return (
            <div className="min-h-screen bg-transparent flex items-center justify-center p-4">
                <div className="text-center space-y-4 max-w-md">
                    ...
                    <p className="text-muted-foreground font-medium">You must be logged in as an organizer to manage your profile.</p>
                    <Link href="/">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3">
                            <h1 className="text-4xl md:text-6xl font-black tracking-tighter uppercase italic leading-none">
                                Manage <span className="text-primary italic underline decoration-primary decoration-4 underline-offset-4">Organizer Profile</span>
                            </h1>
                        </div>
                    </div>
                        ...
                        <div className="p-8 bg-card border border-border rounded-3xl space-y-6 shadow-xl shadow-primary/5">
                            <div className="space-y-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-sm font-bold text-muted-foreground uppercase tracking-widest">{user?.organizerProfile?.name || 'Organizer'}</p>
                                </div>
                            </div>
