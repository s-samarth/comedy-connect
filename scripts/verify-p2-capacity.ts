...
import { showService } from "../packages/backend/services/shows/show.service";
import { prisma } from "../packages/backend/lib/prisma";
import { UserRole } from "@prisma/client";

async function verifyCapacityReduction() {
    console.log("Starting P2.1 Verification in script...");
    ...
    try {
        ...
        // Cleanup
        await prisma.user.delete({ where: { id: user.id } }); // Cascades to shows/bookings
